    ...
    return(
        ...
        <link rel="icon" href="/images/favicon-48x48.ico" />
            ...
            <main className={styles.main}>
                ...
                <div className={styles.buttonChart}>
                    <h3 className={styles.heading}>Buttons</h3>
                    <div className={styles.buttonList}>
                        <div className={styles.row}>
                            <p className={styles.note}>Quiz's button/ chips</p>
                            <div className={styles.buttonCard}>
                                <button className={styles.quiz}>Option 1</button>
                                <button className={styles.quiz_chosen}>Option 2</button>
                            </div>
                            <div className={styles.buttonCard}>
                                <button className={styles.chip}>All</button>
                                <button className={styles.chip_chosen}>Daily</button>
                            </div>
                        </div>

                        <div className={styles.row}>
                            <p className={styles.note}>Text button/ Icon button/ Text & Icon button</p>
                            <div className={styles.buttonCard}>
                                <button className={styles.text}>Choose this!</button>
                                <button className={styles.textnicon}>
                ...
                <div className={styles.graphics}>
                    ...
                    <div className={styles.ratingFrames}>
                        <Image 
                        ...
                        <div className={styles.inventory}>
                            <Image 
                            src={"/images/inventory_categories copy.png"} 
                            ...
                            />
                            <Image 
                            src={"/images/inventory_categories-dark copy.png"} 
