    ...
    return(
        <>
            ...
            <p className={styles.bio}>
                The logo for Clotho showcases the essence of the app's closet organization features.
                <ul>
                    <li> The bold and clean font used for the name "Clotho" ensures readability and brand recognition.</li>
                </ul>
            </p>
            </div>
